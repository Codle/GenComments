...
train_src=$data/train_${src_language}
train_tgt=$data/train_${tgt_language}
valid_src=$data/val_${src_language}
valid_tgt=$data/val_${tgt_language}
test_src=$data/test_${src_language}
test_tgt=$data/test_${tgt_language}
